...
export class AuthService {
    ...
    static async handleStudentRole(
        ...
        try {
            ...
            Logger.error(
                `[AuthService.handleStudentRole] Error: ${error.message}`
            );
            throw error;
        }
    }
    ...
    static async handleAdminRole(
        ...
        try {
            ...
            Logger.error(
                `[AuthService.handleAdminRole] Error: ${error.message}`
            );
            throw error;
        }
    }
    ...
    static async createRoleUser(
        ...
        try {
            ...
            Logger.error(
                `[AuthService.createRoleUser] Error: ${error.message}`
            );
            throw error;
        }
    }
    ...
    static async generateJWTPayload(user: User): Promise<string> {
        try {
            ...
            Logger.error(
                `[AuthService.generateJWTPayload] Error: ${error.message}`
            );
            throw error;
        }
    }
